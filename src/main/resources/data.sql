...
INSERT INTO health_insurance_location (id, location) VALUES (1, 'HCM');
INSERT INTO health_insurance_location (id, location) VALUES (2, 'HN');
INSERT INTO health_insurance_location (id, location) VALUES (3, 'CT');

--INSERT INTO `isc`.`address` (`id`, `address_type`, `post_address`, `pre_address`, `employee_id`) VALUES ('1', 'PERMANENT', 'TPHCM', '123 Dong Hoa, Ward 3, District 5', '1');
--INSERT INTO `isc`.`address` (`id`, `address_type`, `post_address`, `pre_address`, `employee_id`) VALUES ('2', 'TEMPORARY', 'TPHCM', '417 Dong Hoa, Ward 3, District 7', '1');
--
--INSERT INTO health_insurance (id, address_type, `code`, `expiration_date`, `employee_id`, `health_insurance_location`) VALUES ('1', 'PERMANENT', 'BH123123', '2022-11-11', '1', '1');
--INSERT INTO health_insurance` (`id`, `address_type`, `code`, `expiration_date`, `employee_id`, `health_insurance_location`) VALUES ('2', 'TEMPORARY', 'BH111111', '2023-12-12', '1', '2');
--INSERT INTO health_insurance` (`id`, `address_type`, `code`, `expiration_date`, `employee_id`, `health_insurance_location`) VALUES ('3', 'PERMANENT', 'BH123333', '2025-12-12', '2', '3');

insert into user(id,username,password) values (1,"nghia","admin123")