...
public class AssignmentServiceImpl extends AbstractCRUDBean<Assignment>  implements AssignmentService {
    ...
    @Inject
    PersistenceService<Assignment> persistenceService;
    ...
    public List<AssignmentDTO> getAssignments() {
        TypedQuery<Assignment> query = entityManager.createNamedQuery(Assignment.GET_ALL, Assignment.class);
        return assignmentMapper.AssignmentsToAssignmentDtos(query.getResultList());
    }
